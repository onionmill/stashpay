...
export async function init() {
  ...
  console.log(`Minimum on-chain amount, in sats: ${currentOnchainLimits.receive.minSat}`)
  console.log(`Maximum on-chain amount, in sats: ${currentOnchainLimits.receive.maxSat}`)
